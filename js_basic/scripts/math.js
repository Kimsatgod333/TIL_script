...
//생년월일 입력후 '계산' 버튼 클릭시 생일로부터 지금가지 몇일이 지났는지, 몇시간이 지났는지 보여주는 프로그램(양력기준)
//지금까지 흐른 날짜 계산법: 1000*60*60*24로 나누기
//지금까지 흐른 시간 계산법: 1000*60*60으로 나누기
...
function birthFunc(){
    ...
    //오늘 날짜에서 생년월일 뺴기
    //new Date에서 복잡한 특수문자 및 문자를 포함하기 때문에 숫자만 반환하여 계산하도록 getTime() 함수 활용
